...
class The_Ball_v2_2026_Theme {
	 ...
	 * @since 1.0.0
	 * @access public
	 * @var The_Ball_v2_2026_Geo_Mashup
	 */
	public $geo_mashup;

	/**
	 * The Ball 2026-2027 Shortcode object.
	 *
	 * @since 1.0.0
	 * @access public
	 * @var The_Ball_v2_2026_Theme_Shortcode_The_Ball
	 */
	...
	public function initialise() {
		 ...
		 * @since 1.0.0
		 */
		do_action( 'the_ball_v2_2026/theme/loaded' );
	...
	private function setup_objects() {
		...
		/*
		// Instantiate classes.
		$this->geo_mashup         = new The_Ball_v2_2026_Geo_Mashup( $this );
		$this->shortcode_the_ball = new The_Ball_v2_2026_Theme_Shortcode_The_Ball( $this );
		*/
